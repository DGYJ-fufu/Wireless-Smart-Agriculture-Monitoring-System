...
void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart, uint16_t Size)
{
  ...
  {
    AT_UartIdleCallback(&g_at_handle, huart, Size);
  }
}
/* USER CODE END PFP */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	if (LoRa_HW_Init())
  {
    printf("LoRa Hardware Init OK.\r\n");
  }
  else
  {
    printf("[FATAL] LoRa Hardware Init Failed!\r\n");
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_DC_Pin|LCD_RESET_Pin|LCD_BLK_Pin|LCD_CS2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LORA_RESET_Pin LCD_DC_Pin LCD_RESET_Pin LCD_BLK_Pin
                           LCD_CS2_Pin */
  GPIO_InitStruct.Pin = LORA_RESET_Pin|LCD_DC_Pin|LCD_RESET_Pin|LCD_BLK_Pin
                          |LCD_CS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
